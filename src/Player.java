...
public class Player implements IRenderable, Hitable {
	...
	public void draw(Graphics2D g2) {
		...
		//DrawingUtility.drawCenteredString(g2, this.getPercentHitPoint()+"%", new Rectangle(this.x-RADIUS,this.y-RADIUS,RADIUS*2,RADIUS*2), new Font(Font.SANS_SERIF,0,20));
	...
	private void drawHealthBar(Graphics2D g2){
		...
		g2.fillRect(0, GameScreen.screenHeight-HEALTH_BAR_MAX_HEIGHT, (int) (getPercentHitPoint()*HEALTH_BAR_MAX_WIDTH/100.0), HEALTH_BAR_MAX_HEIGHT);
	}
